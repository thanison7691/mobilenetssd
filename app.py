...
lineaccesstoken = 'j8bm1Gf8k4/lREoN427X0eMipysboChT2et20EU+76oOCu/epqvJBx8p+M6NF0nlCl4R3JStYozcyvAQRq6GGXV0JgWxSEAqDTT7FEtvqjZb7Dma9+S7yjJ26N1GrUxrc9Yxh3gl41802FV8r2OZ3gdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี" :
            replyObj = TextSendMessage(text="ดีจ้ะ")
            line_bot_api.roply_message(rtoken, replyObj
        elif msg == "ทำไร" :
            replyObj = TextSendMessage(text="กินข้าว")
            line_bot_api.reply_message(rtoken, replyObj)                          
        elif msg == "อิ่มยัง" :
            replyObj = TextSendMessage(text="จะอิ่มแล้ว")
            line_bot_api.reply_message(rtoken, replyObj)                          
        elif :
            headers = request.headers
            json_headers = ({​k:v for k, v in headers.items()}​)
            json_headers.update({​'Host':'dialogflow.cloud.google.com'}​)
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/df39cc82-c94b-4524-ae46-e9aac673b8b9"
